...
name : ```Irfan Developer```</br>
age : ```20```</br>
link : [facebook](https://www.facebook.com/itsi.rfuxholifa20252025).</br>

## CREDITS

original file : [BotPack](https://replit.com/@YanMaglinte/BotPack?v=1) by ```YanMaglinte```</br>
modified : [IRFAN](https://replit.com/@xaikonayan/NAYAN-BOT?v=1) by ```Irfan Developer```
